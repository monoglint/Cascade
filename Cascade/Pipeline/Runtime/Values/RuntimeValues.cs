...
namespace Cascade.Pipeline.Runtime.Values
{
    ...
    */
    ...
    public sealed class CsFunctionExpressionValue(List<ParameterExpression> parameters, Func<Interpreter, Domain, LocationInfo, List<FirstClassValue>, FirstClassValue> callMethod) : FirstClassValue
    {
        ...
        public Func<Interpreter, Domain, LocationInfo, List<FirstClassValue>, FirstClassValue> CallMethod { get; set; } = callMethod;
        ...
        public FirstClassValue Call(Interpreter interpreter, LocationInfo callLocation, Domain parentDomain, List<FirstClassValue> arguments)
        {
            ...
            return CallMethod(interpreter, localDomain, callLocation, arguments);
        }
    }
    ...
    public sealed class ObjectExpressionValue : MemberContainerValue
    {
        ...
        public ObjectExpressionValue(ClassExpressionValue inheritedClass)
        {
            ...
            // If there is a little bitta that polymorphism going on here...
